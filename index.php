        ...
        <div class="mdui-container" style="max-width: 500px;">
            <div class="mdui-card" style="border-radius: 16px;">
                ...
                <div class="mdui-card-content">
                    <h2 style='font-weight: 400;line-height:30px'>贫穷限制了我的想象力，创造力，巧克力。<br />希望您帮我摆脱贫穷。</h2>
                    <!-- 加载 -->
                    ...
                    <div class="mdui-textfield">
                        <input class="mdui-textfield-input" id="money" type="text" value='1' placeholder="1" />
                        <div class="mdui-textfield-helper">
                            扶贫金额
                        </div>
                    </div>
                    <div class="mdui-textfield">
                        <textarea class="mdui-textfield-input" rows="4" id="comment" placeholder="努力活下去">努力活下去</textarea>
                        <div class="mdui-textfield-helper">
                            扶贫留言
                        </div>
                    </div>
                ...
                <div class="mdui-card-actions">
                    <button id="button" onclick="go()" class="mdui-btn mdui-color-theme-accent mdui-ripple mdui-float-right" style="border-radius: 16px;">扶贫</button>
                </div>
            </div>
        </div>
        <div style='Height:20px'></div>
